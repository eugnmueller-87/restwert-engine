...
GENERATED by `restwert.lake.feeds.write_data_lake_md` from `restwert/lake/feeds.py` and `restwert/lake/schema_lake.py` (package version 0.3.0). Do not edit by hand.
