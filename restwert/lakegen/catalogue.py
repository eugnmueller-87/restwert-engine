...
``variants.csv`` (622 variants, 541 with a public launch RRP, gross EUR) are read
through ``restwert.market.anchors.read_tables``. A slug is *usable* when it has a
parsed launch date and at least one priced variant (208 of 233). The fleet draws
